...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('CRM_CUSTOMER_ESTIMATE', function (Blueprint $table) {
            $table->integer('ESTIMATE_ID', true)->index('ESTIMATE_ID');
            ...
            $table->boolean('SENT_GOOGLE_REVIEW_LINK')->default(false);
            $table->string('GOOGLE_LINK_DESCRIPTION')->nullable();
            $table->integer('QB_EST_ID')->nullable();
            $table->longText('QBO_DETAILS')->nullable();
            $table->boolean('SPOTLIGHT_STATUS')->default(false)->comment('0 => No, 1 - <20% of of W-Budget, 2 => >65% of Budget, 3 => >75% of Cost');
    ...
    {
        Schema::dropIfExists('CRM_CUSTOMER_ESTIMATE');
    }
};
