...
const columns: GridColDef[] = [
  ...
  {
    flex: 0.125,
    field: 'no. of estimate',
    minWidth: 130,
    headerName: 'no. of estimate',
    renderCell: (params: GridRenderCellParams) => (
      <Typography variant='body2' sx={{ color: 'text.primary' }}>
        {params.row.age}
      </Typography>
  ...
  {
    flex: 0.125,
    field: 'no. of insurance',
    minWidth: 130,
    headerName: 'no. of insurance',
    renderCell: (params: GridRenderCellParams) => (
      <Typography variant='body2' sx={{ color: 'text.primary' }}>
        {params.row.age}
      </Typography>
...
export default AverageCollectionsList
