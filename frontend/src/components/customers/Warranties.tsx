...
const Warranties = () => {
  ...
  return (
    <Card>
      <CardContent>
        <div className='warranties_sectioon' style={{display:"flex",justifyContent:"space-between"}}>
          <Typography variant='h6'>Warranty Certification List</Typography>
          <Link href='/customers/warranty/add'>
          <Button
            variant='outlined'
            startIcon={<AddIcon />}
          >
