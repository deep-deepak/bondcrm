...
const columns: GridColDef[] = [
  ...
  {
    flex: 0.125,
    field: 'Estimate Created ON',
    minWidth: 130,
    headerName: 'Estimate Created ON',
    renderCell: (params: GridRenderCellParams) => (
      <Typography variant='body2' sx={{ color: 'text.primary' }}>
        {params.row.age}
      </Typography>
  ...
  {
    flex: 0.125,
    field: 'Customer Created ON',
    minWidth: 130,
    headerName: 'Customer Created ON',
    renderCell: (params: GridRenderCellParams) => (
      <Typography variant='body2' sx={{ color: 'text.primary' }}>
        {params.row.age}
      </Typography>
  ...
  },
  {
    ...
    flex: 0.125,
    field: 'Sent Estimate Date',
    minWidth: 130,
    headerName: 'Sent Estimate Date',
    renderCell: (params: GridRenderCellParams) => (
      <Typography variant='body2' sx={{ color: 'text.primary' }}>
        {params.row.age}
      </Typography>
  ...
  {
    flex: 0.125,
    field: 'Total open Count',
    minWidth: 130,
    headerName: 'Total open Count',
    renderCell: (params: GridRenderCellParams) => (
      <Typography variant='body2' sx={{ color: 'text.primary' }}>
        {params.row.age}
      </Typography>
  ...
  {
    flex: 0.125,
    field: 'Last Opened Date',
    minWidth: 130,
    headerName: 'Last Opened Date',
    renderCell: (params: GridRenderCellParams) => (
      <Typography variant='body2' sx={{ color: 'text.primary' }}>
        {params.row.age}
      </Typography>
...
export default OpenedEstimateList
