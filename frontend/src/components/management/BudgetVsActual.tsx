...
const columns: GridColDef[] = [
  ...
  {
    flex: 0.125,
    field: 'Actual Budget (CRM)',
    minWidth: 130,
    headerName: 'Actual Budget (CRM)',
    renderCell: (params: GridRenderCellParams) => (
      <Typography variant='body2' sx={{ color: 'text.primary' }}>
        {params.row.age}
      </Typography>
  ...
  {
    flex: 0.125,
    field: 'Cost Percentage (%)',
    minWidth: 130,
    headerName: 'Cost Percentage (%)',
    renderCell: (params: GridRenderCellParams) => (
      <Typography variant='body2' sx={{ color: 'text.primary' }}>
        {params.row.age}
      </Typography>
...
export default BudgetVsActualList
