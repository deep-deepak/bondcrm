...
const columns: GridColDef[] = [
  ...
  {
    flex: 0.125,
    field: 'spotlight status',
    minWidth: 130,
    headerName: 'spotlight status',
    renderCell: (params: GridRenderCellParams) => (
      <Typography variant='body2' sx={{ color: 'text.primary' }}>
        {params.row.age}
      </Typography>
  ...
  {
    flex: 0.125,
    field: 'spotlight activity',
    minWidth: 130,
    headerName: 'spotlight activity',
    renderCell: (params: GridRenderCellParams) => (
      <Typography variant='body2' sx={{ color: 'text.primary' }}>
        {params.row.age}
      </Typography>
  ...
  {
    flex: 0.125,
    field: 'expectd budget',
    minWidth: 130,
    headerName: 'expectd budget',
    renderCell: (params: GridRenderCellParams) => (
      <Typography variant='body2' sx={{ color: 'text.primary' }}>
        {params.row.age}
      </Typography>
      ...
      <CardContent>
        ...
        <Grid item xs={12} sm={4}>
          ...
          <Grid item xs={12} sm={4}>
            <MultiSelect
              name='job_status'
              label='Select Spotlight Activity'
              defaultValue={options.job_status}
              onChange={onChange}
              id='job-status'
              options={statuses.map((status: any, key: number) => {
...
export default EstimateSpotlightsList
